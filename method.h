...
public:
	...
	virtual double SetGradFirst(vector <double> grad) const { double q = 0.0; return q; };
	virtual double SetGradRegular(vector <double> grad) const { double q = 0.0; return q; };
	virtual void UpdateX(vector <double> x, vector <double> grad) const {};
